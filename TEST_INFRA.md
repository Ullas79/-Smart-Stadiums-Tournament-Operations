...
- **Invocation**: Executes a comprehensive suite of 172 backend tests validating both successful API flows and edge/boundary conditions.
...
- **Directory layout**:
  - `backend/tests/test_e2e_suite.py` will contain all the 172 backend tests.
...
- Total E2E Tests: 172 backend tests + 7 frontend component tests
